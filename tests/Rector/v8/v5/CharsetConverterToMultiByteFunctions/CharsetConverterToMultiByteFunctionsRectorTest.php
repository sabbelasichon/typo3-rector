...
final class CharsetConverterToMultiByteFunctionsRectorTest extends AbstractCommunityRectorTestCase
{
    /**
    ...
    {
        return CharsetConverterToMultiByteFunctionsRector::class;
    }
}
