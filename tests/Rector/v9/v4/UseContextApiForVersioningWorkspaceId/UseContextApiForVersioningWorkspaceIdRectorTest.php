...
final class UseContextApiForVersioningWorkspaceIdRectorTest extends AbstractCommunityRectorTestCase
{
    /**
    ...
    {
        return UseContextApiForVersioningWorkspaceIdRector::class;
    }
}
