...
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateEvalIntAndDouble2ToTypeNumberRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateInputDateTimeRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateInternalTypeFolderToTypeFolderRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateNullFlagRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigratePasswordAndSaltedPasswordToPasswordTypeRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateRenderTypeColorpickerToTypeColorRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateRequiredFlagRector;
use Ssch\TYPO3Rector\Rector\v12\v0\MigrateToEmailTypeRector;
use Ssch\TYPO3Rector\Rector\v12\v0\RemoveCruserIdRector;
use Ssch\TYPO3Rector\Rector\v12\v0\RemoveTableLocalPropertyRector;
use Ssch\TYPO3Rector\Rector\v12\v0\RemoveTCAInterfaceAlwaysDescriptionRector;
