...
use Ssch\TYPO3Rector\Rector\TYPO312\v0\AddMethodToWidgetInterfaceClassesRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ChangeExtbaseValidatorsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ImplementSiteLanguageAwareInterfaceRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\MigrateQueryBuilderExecuteRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\RemoveMailerAdapterInterfaceRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\RemoveRelativeToCurrentScriptArgumentsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\RemoveTSFEConvOutputCharsetCallsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\RemoveTSFEMetaCharSetCallsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\RemoveUpdateRootlineDataRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ReplaceContentObjectRendererGetMailToWithEmailLinkBuilderRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ReplaceExpressionBuilderMethodsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ReplacePageRepoOverlayFunctionRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ReplaceTSFECheckEnableFieldsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\ReplaceTSFEWithContextMethodsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\SubstituteCompositeExpressionAddMethodsRector;
use Ssch\TYPO3Rector\Rector\TYPO312\v0\UseCompositeExpressionStaticMethodsRector;
