...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set(ReplaceAnnotationRector::class)
        ->arg('$oldToNewAnnotations', ['lazy' => 'TYPO3\CMS\Extbase\Annotation\ORM\Lazy', 'cascade' => 'TYPO3\CMS\Extbase\Annotation\ORM\Cascade("remove")', 'transient' => 'TYPO3\CMS\Extbase\Annotation\ORM\Transient']);
    ...
    $services->set(RenameClassMapAliasRector::class)
        ->arg('$classAliasMaps', ['../../../Migrations/Fluid/ClassAliasMap.php']);
