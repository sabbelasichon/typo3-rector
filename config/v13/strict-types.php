...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(
        ...
        [
            ...
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'offsetSet', 0, new MixedType()),
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'offsetSet', 1, new MixedType()),
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'offsetExists', 0, new MixedType()),
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'offsetUnset', 0, new MixedType()),
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'offsetGet', 0, new MixedType()),
            ...
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'attach', 1, new MixedType()),
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'detach', 0, new GenericObjectType('object', [])),
            new AddParamTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'setInfo', 0, new MixedType()),
    ...
    $rectorConfig->ruleWithConfiguration(
        ...
        [
            ...
            new AddReturnTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'offsetGet', new MixedType()),
            ...
            new AddReturnTypeDeclaration('TYPO3\CMS\Extbase\Persistence\ObjectStorage', 'getInfo', new MixedType()),
