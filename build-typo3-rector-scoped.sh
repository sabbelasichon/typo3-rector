...
php -d memory_limit=-1 php-scoper.phar add-prefix config src templates stubs Migrations vendor composer.json --output-dir "../$SCOPED_DIRECTORY" --config scoper.php --force --ansi --working-dir "$NESTED_DIRECTORY"
...
chmod 777 "$SCOPED_DIRECTORY/vendor/bin/rector"
chmod 777 "$SCOPED_DIRECTORY/vendor/bin/rector.php"
