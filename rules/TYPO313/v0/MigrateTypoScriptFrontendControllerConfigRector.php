 ...
 * @see \Ssch\TYPO3Rector\Tests\Rector\v13\v0\MigrateTypoScriptFrontendControllerConfigRector\MigrateTypoScriptFrontendControllerConfigRectorTest
 */
final class MigrateTypoScriptFrontendControllerConfigRector extends AbstractRector implements DocumentedRuleInterface
{
    /**
     * @readonly
     */
    ...
    {
        return new RuleDefinition("Migrate `TypoScriptFrontendController->config['config']`", [new CodeSample(
            <<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        return $this->nodeFactory->createMethodCall($requestFetcherVariable, 'getConfigArray');
    }
