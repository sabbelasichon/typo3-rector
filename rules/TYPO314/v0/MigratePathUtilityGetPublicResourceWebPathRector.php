 ...
 * @see \Ssch\TYPO3Rector\Tests\Rector\v14\v0\MigratePathUtilityGetPublicResourceWebPathRector\MigratePathUtilityGetPublicResourceWebPathRectorTest
 */
final class MigratePathUtilityGetPublicResourceWebPathRector extends AbstractRector implements DocumentedRuleInterface
{
    /**
     * @readonly
     */
    ...
    {
        return new RuleDefinition('Migrate `UtilityPathUtility::getPublicResourceWebPath()`', [new CodeSample(
            <<<'CODE_SAMPLE'
