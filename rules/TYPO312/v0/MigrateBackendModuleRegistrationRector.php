...
final class MigrateBackendModuleRegistrationRector extends AbstractRector
{
     ...
     * @readonly
     */
    private FormatPerservingPrinter $formatPreservingPrinter;
...
//        }
    ...
    private function parseFileAndDecorateNodes(File $file): ?SystemError
    {
        try {
            ...
            return new SystemError($analysedCodeException->getMessage(), $file->getFilePath(), $analysedCodeException->getLine());
