...
namespace Ssch\TYPO3Rector\PhpParser\Printer;
...
class PrettyTypo3Printer extends Standard
{
    ...
    /**
     * It removes all spaces extra to parent
     */
     ...
     *
     * @source TYPO3 extension kickstarter
     */
    ...
    private function shouldRenderNodesInMultiline(array $nodes): bool
    {
        ...
        // If arguments of method/function arguments are too long, activate multiline
        $maxLineLength = 100;
