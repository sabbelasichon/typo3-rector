...
final class SolrSiteToSolrRepositoryRector extends AbstractRector
{
    ...
    {
        return new RuleDefinition('Use SiteRepository instead of instantiating class Site directly with page id', [
            new CodeSample(
                <<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        $node->args[0]->value = $this->nodeFactory->createClassConstReference(
            'ApacheSolrForTypo3\Solr\Domain\Site\SiteRepository'
        );
