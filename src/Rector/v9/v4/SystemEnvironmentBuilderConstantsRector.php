...
/**
 * @changelog https://docs.typo3.org/c/typo3/cms-core/main/en-us/Changelog/9.4/Deprecation-85793-SeveralConstantsFromSystemEnvironmentBuilder.html
...
final class SystemEnvironmentBuilderConstantsRector extends AbstractRector
{
     ...
     */
    private const MAP_CONSTANTS_TO_STRING = [
        ...
        'NUL' => "\0",
        'SUB' => '26',
        'T3_ERR_SV_GENERAL' => 'ERROR_GENERAL',
        'T3_ERR_SV_NOT_AVAIL' => 'ERROR_SERVICE_NOT_AVAILABLE',
        'T3_ERR_SV_WRONG_SUBTYPE' => 'ERROR_WRONG_SUBTYPE',
        'T3_ERR_SV_NO_INPUT' => 'ERROR_NO_INPUT',
        'T3_ERR_SV_FILE_NOT_FOUND' => 'ERROR_FILE_NOT_FOUND',
        'T3_ERR_SV_FILE_READ' => 'ERROR_FILE_NOT_READABLE',
        'T3_ERR_SV_FILE_WRITE' => 'ERROR_FILE_NOT_WRITEABLE',
        'T3_ERR_SV_PROG_NOT_FOUND' => 'ERROR_PROGRAM_NOT_FOUND',
