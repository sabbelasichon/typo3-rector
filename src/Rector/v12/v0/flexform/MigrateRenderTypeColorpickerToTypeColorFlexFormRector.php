 ...
 */
final class MigrateRenderTypeColorpickerToTypeColorFlexFormRector implements FlexFormRectorInterface
{
...
CODE_SAMPLE
    ...
    private function refactorColumn(DOMDocument $domDocument, ?DOMElement $configElement): void
    {
        ...
        $this->changeTcaType($domDocument, $configElement, 'color');
