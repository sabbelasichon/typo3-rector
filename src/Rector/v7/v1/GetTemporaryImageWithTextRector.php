...
/**
 * @changelog https://docs.typo3.org/c/typo3/cms-core/main/en-us/Changelog/7.1/Deprecation-46770-LocalImageProcessorGraphicalFunctions.html
    ...
    public function refactor(Node $node): ?Node
    {
        ...
        return $this->nodeFactory->createMethodCall(
            $this->nodeFactory->createStaticCall(
                ...
                'makeInstance',
                [$this->nodeFactory->createClassConstReference('TYPO3\CMS\Core\Imaging\GraphicalFunctions')]
            ),
