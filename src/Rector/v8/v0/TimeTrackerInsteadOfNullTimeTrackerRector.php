...
/**
 * @changelog https://docs.typo3.org/c/typo3/cms-core/main/en-us/Changelog/8.0/Deprecation-73185-DeprecateNullTimeTracker.html
...
CODE_SAMPLE
    ...
    private function isObjectManagerCall(Node $node): bool
    {
        ...
        if (! $this->nodeTypeResolver->isMethodStaticCallOrClassMethodObjectType(
            $node,
            new ObjectType('TYPO3\CMS\Extbase\Object\ObjectManager')
        )) {
            return false;
        }
